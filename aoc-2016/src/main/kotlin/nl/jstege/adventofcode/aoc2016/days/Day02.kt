...
class Day02 : Day() {
    ...
    private val FIRST_STARTING_INDEX = Point(2, 2)
    private val SECOND_STARTING_INDEX = Point(1, 3)
    ...
    override fun first(input: Sequence<String>): Any =
            iterate(input, FIRST_KEYPAD, FIRST_STARTING_INDEX)
                    .joinToString("")


    override fun second(input: Sequence<String>): Any =
            iterate(input, SECOND_KEYPAD, SECOND_STARTING_INDEX)
                    .map { it.toHexChar().toUpperCase() }
                    .joinToString("")


    private fun iterate(input: Sequence<String>, keypad: Array<Array<Int>>,
                        startingPosition: Point) =
            input.fold(Pair(startingPosition, listOf<Int>()), { (pos, code), line ->
