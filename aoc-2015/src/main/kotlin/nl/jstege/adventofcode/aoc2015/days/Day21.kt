...
class Day21 : Day() {
    ...
    data class Player(var hitPoints: Int, var unarmedAttack: Int, var unarmedDefense: Int) {
        ...
        companion object Parser {
            @JvmStatic fun of(input: List<String>): Player {
    ...
    sealed class Item(val rating: Int, val itemType: ItemType) {
